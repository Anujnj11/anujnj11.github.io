...
export default function Intro() {
    ...
    return (
        <section className='relative min-h-[80vh] flex flex-col lg:flex-row items-start lg:items-center lg:justify-between pt-10 container mx-auto px-8 xl:px-32 lg:min-h-[50vh] overflow-hidden'>
            <div className='max-w-2xl'>
                ...
                <p className="mt-7 text-lg leading-relaxed font-medium text-gray-400 max-w-xl">
                    Software developer with {calculateInYears(careerStartedAt)} years of experience as a back-end developer, passionate about programming and eager to tackle any workplace challenge 👨🏽‍💻🇮🇳! Highly qualified, dedicated, and versatile professional with expertise in all aspects of programming and development. Excellent analytical, organizational, and technical skills, as well as strong communication and interpersonal abilities.
                </p>

                <div className="flex flex-col sm:flex-row mt-10 gap-4">
                    <a className="inline-flex items-center gap-1 group/button rounded-full hover:scale-105 focus:outline-none transition ring-offset-gray-900 bg-gray-800/90 shadow-xl shadow-black/20 ring-1 [&amp;:not(:focus)]:ring-inset ring-gray-700/30 hover:bg-gray-700/70 focus:ring-gray-600 focus:ring-offset-2 text-base font-medium px-5 py-1.5 justify-center" target='_blank' href="https://www.linkedin.com/in/anuj-gupta--/">Let’s connect</a>
                </div>
            </div>
