...
export default function Intro() {
    return (
        <section className='relative min-h-[110vh] sm:min-h-[140vh] flex flex-col lg:flex-row items-start lg:items-center lg:justify-between pt-10 container mx-auto px-8 xl:px-32 overflow-x-hidden'>
